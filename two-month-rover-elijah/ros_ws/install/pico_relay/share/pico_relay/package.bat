...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\pico_relay\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\pico_relay\hook\ament_prefix_path.bat"
